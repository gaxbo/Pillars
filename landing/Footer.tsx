...
export function Footer() {
  ...
  return (
    <footer className="mx-auto flex max-w-7xl flex-wrap items-center gap-x-6 gap-y-3 px-4 py-10 text-[14px] text-slate-600 sm:px-6 lg:px-8">
      <a
        href="/"
        className="mr-auto rounded-sm text-[17px] font-bold tracking-[-0.02em] text-slate-900 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-blue-700"
      >
        Pillars
      </a>
